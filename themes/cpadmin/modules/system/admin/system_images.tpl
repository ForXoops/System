...
<div style="height: 30px;">
    <div class="">
        ...
        <{if empty($edit_form) && empty($listimg) && empty($multiupload)}>
                <button id="xo-addcat-btn" class="ui-corner-all " onclick="xo_toggle('div#xo-category-add');"
            ...
            <{if !empty($cat_img) || !empty($listimg)}>
                <button id="xo-addimg-btn" class="ui-corner-all " onclick="xo_toggle('div#xo-images-add');"
            ...
            <{/if}>
            <{if !empty($listimg)}>
                <button id="xo-addavatar-btn" class="ui-corner-all " onclick='location="admin.php?fct=images&amp;op=multiupload&amp;imgcat_id=<{$imgcat_id}>"'
                ...
                <tr class="<{cycle values='odd, even'}> txtcenter">
                    ...
                    <td class="xo-actions txtcenter">
                        ...
                        <{if isset($xoops_isadmin)}>
                            <a href="admin.php?fct=images&amp;op=editcat&amp;imgcat_id=<{$cat.id}>" data-toggle="tooltip" title="<{$smarty.const._EDIT}>">
                                <img src="<{xoAdminIcons 'edit.png'}>" alt="<{$smarty.const._EDIT}>"/>
                            </a>
                            <a href="admin.php?fct=images&amp;op=delcat&amp;imgcat_id=<{$cat.id}>" data-toggle="tooltip" title="<{$smarty.const._EDIT}>">
            ...
            <div class="floatleft">
                <div class="ui-corner-all xo-thumb txtcenter">
                    <div class="xo-thumbimg">
                        <img data-toggle="tooltip" src="<{$xoops_url}>/image.php?id=<{$img.image_id}>&amp;width=120&amp;height=120" alt="<{$img.image_nicename}>"
                    ...
                    <div class="xo-actions txtcenter">
                        ...
                        <a class="lightbox tooltip" href="<{$xoops_upload_url}>/<{$img.image_name}>" title="<{$smarty.const._PREVIEW}>">
                            ...
                            <a data-toggle="tooltip" href="admin.php?fct=images&amp;op=editimg&amp;image_id=<{$img.image_id}>" title="<{$smarty.const._EDIT}>">
                                <img src="<{xoAdminIcons 'edit.png'}>" alt="<{$smarty.const._EDIT}>"/>
                            </a>
                            <a data-toggle="tooltip" href="admin.php?fct=images&amp;op=delfile&amp;image_id=<{$img.image_id}>" title="<{$smarty.const._DELETE}>">
                                <img src="<{xoAdminIcons 'delete.png'}>" alt="<{$smarty.const._DELETE}>"/>
                            </a>
                            <img data-toggle="tooltip" onclick="display_dialog(<{$img.image_id}>, true, true, 'slide', 'slide', 120, 350);"
...
<{$image_form.javascript}>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><{$image_form.title}></h3>
        </div>
        <div class="card-body">
...
<{$imagecat_form.javascript}>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><{$imagecat_form.title}></h3>
        </div>
        <div class="card-body">
