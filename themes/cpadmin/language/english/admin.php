...
\define('_CPADMIN_XOOPS_LICENSE', 'XOOPS License');
\define('_CPADMIN_XOOPS_LINKS', 'XOOPS Links');
...
\define('_CPADMIN_CODESVN', 'Code Repository');
\define('_CPADMIN_REPORTBUG', 'Report Bug');
